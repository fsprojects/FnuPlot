...
<div class="row">
  ...
  <div class="span6">
    <div class="well well-small" id="nuget">
      The F# ProjectTemplate library can be <a href="https://nuget.org/packages/FnuPlot">installed from NuGet</a>:
      <pre>PM> Install-Package FnuPlot</pre>
    </div>
  </div>
  <div class="span1"></div>
</div>
...
[License file][license] in the GitHub repository. 
  ...
  [license]: https://github.com/fsprojects/FnuPlot/blob/master/LICENSE.txt
*)
